...
import Img2 from '../../public/about2.png';
import Img3 from '../../public/about3.png';
import Img4 from '../../public/about4.png';
    ...
    return(
        ...
        <div className='h-container'>
            ...
            <div className="image-container">
                        <img className="about-image object-cover" src={Img1} alt="Image 1" />
                        <img className="about-image object-cover" src={Img2} alt="Image 2" />
                        <img className="about-image object-cover" src={Img3} alt="Image 3" />
                        <img className="about-image object-cover" src={Img4} alt="Image 4" />
            </div>
        </div>
        <Footer />
